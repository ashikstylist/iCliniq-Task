...
const CardContent = [
    {
        headerImage : 'https://assets.icliniq.com/v2/assets/images/default-article-home-1.jpg',
        bodyContent : 'Impact of COVID-19 on Female Sexual Health',
        drName: 'Dr. Amrita Jain',
        icon: 'https://img.icliniq.com/doc_photo/dr-neha-singh-rathod-68317-5c9172a2af7c3-sm.jpg',
        dateInfo: '26 Dec 2022 - 2 min read'
    },
    {
...
function Article() {
  ...
  return (
    <div>
        <Header />
        <Breadcrumb content={'Health Articles'} />
        <Banner banner_props={false} />
